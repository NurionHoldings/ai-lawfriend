...
import { buildPhaseBcReadiness } from "@/features/payments/inicis-openmall-aml-client";
import { INICIS_OPENMALL_AML_LIVE_GATE_WIRED } from "@/features/payments/inicis-openmall-aml";
...
export function buildAmlGuidance() {
  const phaseRoadmap = buildPhaseBcReadiness();
  return {
    ...
    endpoints: {
      ...
      phaseBcDoc: "docs/arkaon/INICIS_OPENMALL_AML_PHASE_BC.md",
    },
  };
}
