  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-slate-900">경고 KPI</h1>
      ...
      <div className="flex flex-wrap gap-2 text-sm">
        ...
        <Link
          ...
          className="rounded-xl border border-slate-200 bg-white px-3 py-2 font-medium text-slate-800 hover:bg-slate-50"
        >
          보드로
        </Link>
      </div>
