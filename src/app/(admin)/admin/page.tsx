    ...
    <DashboardShell>
      <div className="flex flex-col gap-10 pb-8">
        ...
        <section
          ...
          className="space-y-5 rounded-2xl border border-slate-200/90 bg-white p-5 text-gray-900 shadow-[0_8px_40px_-12px_rgba(15,23,42,0.18)] ring-1 ring-slate-200/80 sm:space-y-6 sm:rounded-[2rem] sm:p-6 md:p-8"
        >
