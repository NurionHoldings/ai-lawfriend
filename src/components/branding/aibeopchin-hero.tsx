  ...
  return (
    ...
    >
      <div className="relative mx-auto grid max-w-7xl gap-10 px-5 py-8 md:px-8 md:py-14">
        ...
        >
          <div className="flex flex-col gap-3 rounded-2xl border border-aibeop-pale/20 bg-aibeop-pale/10 p-5 transition hover:bg-aibeop-pale/15">
            <p className="text-sm font-semibold text-aibeop-pale">의뢰인</p>
          ...
          <div className="flex flex-col gap-3 rounded-2xl border border-white/10 bg-white/[0.045] p-5 transition hover:bg-white/[0.08]">
            <p className="text-sm font-semibold text-aibeop-pale">변호사</p>
          ...
          <div className="flex flex-col gap-3 rounded-2xl border border-white/10 bg-white/[0.045] p-5 transition hover:bg-white/[0.08]">
            <p className="text-sm font-semibold text-aibeop-pale">관리자·운영</p>
